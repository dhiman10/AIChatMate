...
struct AvatarModel: Hashable {
    ...
    init(avatarId: String, name: String?, characterOption: CharacterOption?, characterAction: CharacterAction?, characterLocation: CharacterLocation?, profileImageName: String?, authorId: String?, dateCreated: Date?) {
